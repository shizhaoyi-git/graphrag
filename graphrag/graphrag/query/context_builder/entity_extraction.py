...
def map_query_to_entities(
    ...
    if query != "":
        ...
        embedding_similarity_time = embedding_end_time - embedding_start_time
        log.info("embedding_similarity_time: %f", embedding_similarity_time)

        # texts = [result.document.text for result in search_results]
        # log.info("Search results texts: %s", texts)
        
        # types_and_descriptions = [(entity.type, entity.description) for entity in all_entities]
        # log.info("All Entities types and descriptions: %s", types_and_descriptions)
        ...
        entity_search_time = entity_end_time - entity_start_time
        log.info("entity_search_time: %f", entity_search_time)
