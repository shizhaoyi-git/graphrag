...
def run(
    ...
    separators = args.get("separators", None)
...
def split_text_on_tokens(
    texts: list[str], splitter: ChineseRecursiveTextSplitter, tick: ProgressTicker
) -> list[TextChunk]:
    """Split incoming text and return chunks."""
    result = []
